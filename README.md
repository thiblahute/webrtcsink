...
with the content, for example move with your mouse, entering keys without the
...
property. The demo located in `www/` of this repository also implements the
protocol and you can easily test this feature , using the [`wpesrc`] for
example.
