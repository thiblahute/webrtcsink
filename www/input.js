...
class Input {
    ...
    _mouseButtonMovement(event) {
        ...
        if (document.pointerLockElement) {
            ...
            data["event"] = "mouse-move"
        }

        if (event.type === 'mousedown') {
            data["event"] = "mouse-button-press";
        } else if (event.type === 'mouseup') {
            data["event"] = "mouse-button-release";
        }
    ...
    attach() {
        ...
        this.keyboard.onkeydown = (keysym) => {
            this.send(JSON.stringify( {"event": "key-press", "key": keysym}));
        };
        this.keyboard.onkeyup = (keysym) => {
            this.send(JSON.stringify( {"event": "key-release", "key": keysym}));
        };
