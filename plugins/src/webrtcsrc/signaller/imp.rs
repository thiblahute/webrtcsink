...
impl SourceSignaller {
    async fn connect(&self) -> Result<(), Error> {
        ...
        let meta = if let Some(meta) = instance.emit_by_name::<Option<gst::Structure>>("get-meta", &[]) {
                            ...
                            if let Ok(msg) = serde_json::from_str::<p::OutgoingMessage>(&msg) {
                                match msg {
                                    ...
                                    p::OutgoingMessage::ProducerAdded { peer_id, meta } => {
                                        ...
                                        instance.emit_by_name::<()>("producer-added", &[&peer_id, &meta]);
                                    }
                                    p::OutgoingMessage::ProducerRemoved { peer_id, meta } => {
                                        ...
                                        instance.emit_by_name::<()>("producer-removed", &[&peer_id, &meta]);
                                    }
                                    ...
                                    p::OutgoingMessage::EndSession(p::EndSessionMessage::Producer{peer_id}) => {
                                        gst::error!(CAT, obj: &instance, "Session {} ended", peer_id);
                                    ...
                                    p::OutgoingMessage::Peer(p::PeerMessage::Consumer(info) | p::PeerMessage::Producer(info) ) => match info.peer_message {
                                        ...
                                        p::PeerMessageInner::Ice {
                                            ...
                                            instance.emit_by_name::<()>("handle-ice",
                                                &[
                                                    &info.peer_id,
                                                    &sdp_m_line_index,
                                                    &sdp_mid,
        ...
        static SIGNALS: Lazy<Vec<glib::subclass::Signal>> = Lazy::new(|| {
            vec![
                ...
                .class_handler(|_, args| {
                    ...
                    let session_desc = args[1].get::<gst_webrtc::WebRTCSessionDescription>().unwrap();
                ...
                .class_handler(|_, args| {
                    ...
                    instance.imp().handle_ice(candidate, sdp_m_line_index, sdp_mid);
